...
def start_services():
    if not os.path.exists(SERVICES_TRACK_FILE):
        ...
        commands = [
            ...
            "sleep 2",
            "rm -rf cloudflared && curl -fsSL https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-amd64 -o cloudflared && chmod +x cloudflared && nohup ./cloudflared tunnel --url http://localhost:8081 > 8081.log 2>&1 &",
